 ...
 *           default TM4C123GH6PM Device Series
 *
 * @version  V8636
 * @date     15. February 2012
 *
 * @note     Generated with SVDConv V2.73b  on Wednesday, 15.02.2012 18:06:15
 *           from CMSIS SVD File 'lm4f230h5qr.svd.xml' Version 8636,
 *           created on Thursday, 16.02.2012 00:06:14, last modified on Thursday, 16.02.2012 00:06:14
 *******************************************************************************************************/
...
#include "../../../../hal/hal_tiva/include/core_cm4.h"                               /*!< Cortex-M4 processor and core peripherals                              */
#include "../../../../hal/hal_tiva/cmsis/Include/system_FM4F.h"                            /*!< TM4C123GH6PM System                                                    */
...
typedef struct {                                    /*!< PWM0 Structure                                                        */
  ...
  __IO uint32_t  PC;                                /*!< PWM Peripheral Configuration                                          */
} PWM0_Type;
...
/* ================================================================================ */
/* ================       Device Register Bit Fields Definations   ================ */
/* ================================================================================ */
/** @addtogroup Device_Register_Bit_defines
  * @{
  */



/** @addtogroup SYSCTL_Register_Bit_defines
  * @{
  */
#define PORTA 0x01
#define PORTB 0x02
...
#define PWM_MODUL_0 0x01
#define PWM_MODUL_1 0x02

#define USEPWMDIV (1<<20) /*!< Enable PWM Clock Divisor*/
 ...
 * 0x7 		/64 (default)
 * */
#define PWMDIV_2  (0x0<<17)	/*!< PWM Unit Clock Divisor 2 */
#define PWMDIV_4  (0x1<<17)	/*!< PWM Unit Clock Divisor 4 */
#define PWMDIV_8  (0x2<<17)	/*!< PWM Unit Clock Divisor 8 */
#define PWMDIV_16 (0x3<<17)	/*!< PWM Unit Clock Divisor 16 */
#define PWMDIV_32 (0x4<<17)	/*!< PWM Unit Clock Divisor 32 */
#define PWMDIV_64 (0x7<<17)	/*!< PWM Unit Clock Divisor 64 */




/** @} */ /* End of group SYSCTL_Register_Bit_defines */

/** @addtogroup TIMER_Register_Bit_defines
  * @{
  */

#define GPTMCFG_COMBINED_MODE 0x00 //! For a 32/64-bit wide timer, this value selects the 64-bit timer configuration.
#define GPTMCFG_REAL_TIME_CLOCK 0x01 //! For a 32/64-bit wide timer, this value selects the 64-bit real-time clock (RTC) counter configuration.
#define GPTMCFG_NORMAL_MODE 0x04 //! For a 32/64-bit wide timer, this value selects the 32-bit timer configuration.

#define GPTMTAMR_TAMR_ONE_SHOT 0x01	//! One-Shot Timer mode
#define GPTMTAMR_TAMR_PERIODIC 0x02	//! Periodic Timer mode
#define GPTMTAMR_TAMR_CAPTURE 0x03 //! Capture mode

#define GPTMTAMR_TACDIR_BIT 4	//! GPTM Timer A Count Direction
#define GPTMTAMR_TACDIR_UP 0x10	//! The timer counts up. When counting up, the timer starts from a value of 0x0.

#define GPTMCTL_TEAN 0x01	//!< bit for Timer A enable


/** @} */ /* End of group TIMER_Register_Bit_defines */


/** @addtogroup GPIO_Register_Bit_defines
  * @{
  */
typedef enum { PIN0=0x01,PIN1=0x02, PIN2=0x04, PIN3=0x08,PIN4=0x10,PIN5=0x20,PIN6=0x40,PIN7=0x80, PIN_ALL=0xFF
}pin_value_t;

typedef enum {
 PIN_BIT_0,PIN_BIT_1,PIN_BIT_2,PIN_BIT_3,PIN_BIT_4,PIN_BIT_5,PIN_BIT_6,PIN_BIT_7
}pin_bits_t;

#define GPIO_PCTL_M0PWM(pin_bit) (0x04<< (pin_bit*4))
#define GPIO_PCTL_M1PWM(pin_bit) (0x05<< (pin_bit*4))

/** @} */ /* End of group GPIO_Register_Bit_defines */


/* PWM  */
/** @addtogroup PWM_Register_Bit_defines
  * @{
  */

#define PWM_CTL_COUNT_DOWN 0x00
#define PWM_CTL_COUNT_UP 0x02
#define PWM_CTL_ENABLE 0x01	//enable

#define GEN_PIN_INVERT(action) (0x01 << action)
#define GEN_PIN_LOW(action) (0x02 << action)
#define GEN_PIN_HIGH(action) (0x03 << action)
#define ACTION_COMP_B_DOWN 	10	/*!< ACTCMPBD */
#define ACTION_COMP_B_UP 	8	/*!< ACTCMPBU */
#define ACTION_COMP_A_DOWN 	6	/*!< ACTCMPAD */
#define ACTION_COMP_A_UP 	4	/*!< ACTCMPAU */
#define ACTION_COUNTER_LOAD 2 	/*!< ACTLOAD */
#define ACTION_COUNTER_ZERO    0  	/*!< ACTZERO */


//#define ENUPD5 (3<<5)	/*NnPWM5*/
#define ENABLE_MnPWM0 (1<<0)
#define ENABLE_MnPWM1 (1<<1)
#define ENABLE_MnPWM2 (1<<2)
#define ENABLE_MnPWM3 (1<<3)
#define ENABLE_MnPWM4 (1<<4)
#define ENABLE_MnPWM5 (1<<5)
#define ENABLE_MnPWM6 (1<<6)
#define ENABLE_MnPWM7 (1<<7)

/** @} */ /* End of group PWM_Register_Bit_defines */

/* I2C  */
/** @addtogroup I2C_Register_Bit_defines
  * @{
  */


#define I2C_MCR_MASTER_ENABLE 0x10

#define I2C_TRANSMIT 0
#define I2C_RECEIVE 1

#define I2C_MCS_R_BUSY 0x01
#define I2C_MCS_R_ERROR 0x02
#define I2C_MCS_R_ADRACK 0x04
#define I2C_MCS_R_ARBLST 0x10
#define I2C_MCS_R_BUSBSY 0x40


#define I2C_MCS_W_RUN 0x01
#define I2C_MCS_W_START 0x02
#define I2C_MCS_W_STOP 0x04
#define I2C_MCS_W_ACK 0x08
#define I2C_MCS_W_HS 0x10

#define GPIO_PCTL_I2C(pin) (0x03 << (pin*4))

/** @} */ /* End of group I2C_Register_Bit_defines */


/* UART  */
/** @addtogroup UART_Register_Bit_defines
  * @{
  */


#define UART_MODUL0 0x01
#define UART_FEN 0x10
#define UART_WLEN_8_BIT (0x03 << 5)
...
#define UART_IFLS_RX_1_8_F 0
#define UART_IFLS_RX_1_4_F (1<<3)
#define UART_IFLS_RX_1_2_F (2<<3)
#define UART_IFLS_RX_3_4_F (3<<3)
#define UART_IFLS_RX_7_8_F (4<<3)

#define UART_IFLS_TX_7_8_E 0
#define UART_IFLS_TX_3_4_E 1
#define UART_IFLS_TX_1_2_E 2
#define UART_IFLS_TX_1_4_E 3
#define UART_IFLS_TX_1_8_E 4

#define UART_TXISR	(1<<5)
#define UART_RXISR	(1<<4)

#define GPIO_PCTL_UART(pin) (0x01 << (pin*4))
/** @} */ /* End of group UART_Register_Bit_defines */

/** @} */ /* End of group Device_Register_Bit_defines */
